...
public enum StringUtil {
    ...
    private StringUtil(char character, int length) {
        this.character = character;
        this.length = length;
    }

    public static StringUtil getDefaultFontInfo(char c) {
        for (StringUtil dFI : values()) {
    ...
    public static String makeCenteredMotd(String message) {
        ...
        for (int j = 0; j < i; j++) {
            ...
            if (c == '§') {
                ...
                StringUtil dFI = getDefaultFontInfo(c);
